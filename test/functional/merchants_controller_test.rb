...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { email: @merchant.email, image: @merchant.image, name: @merchant.name, url: @merchant.url }
    end
  ...
  test "should update merchant" do
    put :update, id: @merchant, merchant: { email: @merchant.email, image: @merchant.image, name: @merchant.name, url: @merchant.url }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
